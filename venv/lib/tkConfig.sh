...
# installed.
TK_PREFIX='/home/shivanshu/Documents/ML project cyber security/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/shivanshu/Documents/ML project cyber security/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/shivanshu/Documents/ML project cyber security/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/shivanshu/Documents/ML project cyber security/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/shivanshu/Documents/ML project cyber security/venv/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/croot/tk_1748849386456/work/tk8.6.14/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/shivanshu/Documents/ML project cyber security/venv/lib/libtkstub8.6.a'
